...
export class Employee extends Component{
    ...
    refreshList(){
        ...
        fetch(variables.API_URL+'Employees/GetEmployee')
        ...
        createClick(){
            fetch(variables.API_URL+'Employees/AddNewEmployee',{
                method:'POST',
                headers:{
            ...
            updateClick(){
                fetch(variables.API_URL+'Employees/UpdateEmployee',{
                    method:'PUT',
                    headers:{
                        'accept':'application/json',
                        'Content-Type' : 'application/json'
                ...
                deleteClick(id){
                    ...
                    fetch(variables.API_URL+'Employees/DeleteEmployee?id='+id,{
                        method:'DELETE',
                        headers:{
                            'Accept':'application/json',
                            'Content-Type':'application/json'
